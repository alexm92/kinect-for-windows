    ...
    public class WaveSegment1 : IGestureSegment
    {
        ...
        public GesturePartResult Update(Skeleton skeleton)
        {
            ...
            if (skeleton.Joints[JointType.HandRight].Position.Y > skeleton.Joints[JointType.ElbowRight].Position.Y)
            {
                ...
                {
                    //Console.WriteLine("Hand right of elbow --> Succeeded");
                    return GesturePartResult.Succeeded;
                }
            }

            //Console.WriteLine("Hand right of elbow --> Failed");
            // Hand dropped
    ...
    public class WaveSegment2 : IGestureSegment
    {
        ...
        public GesturePartResult Update(Skeleton skeleton)
        {
            ...
            if (skeleton.Joints[JointType.HandRight].Position.Y > skeleton.Joints[JointType.ElbowRight].Position.Y)
            {
                ...
                if (skeleton.Joints[JointType.HandRight].Position.X < skeleton.Joints[JointType.ElbowRight].Position.X)
                {
                    //Console.WriteLine("Hand left of elbow --> Succeeded");
                    return GesturePartResult.Succeeded;
                }
            }

            //Console.WriteLine("Hand left of elbow --> Failed");
            // Hand dropped
            return GesturePartResult.Failed;
        }
    }
